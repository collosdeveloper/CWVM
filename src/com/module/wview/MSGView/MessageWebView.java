...
public class MessageWebView extends RigidWebView implements ViewParameters{
    ...
    public void configure() {
        ...
        webSettings.setTextZoom(16); // 12px
